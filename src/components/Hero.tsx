...
export default function Hero() {
  return (
    <section id="hero" className="text-center py-20 animate-fade-in">
      ...
      <p className="mt-4 text-lg md:text-xl font-medium text-gray-600 dark:text-gray-300 [animation-delay:0.4s] opacity-0 animate-fade-in-up">
      ...
      <p className="mt-6 max-w-2xl mx-auto text-base [animation-delay:0.6s] opacity-0 animate-fade-in-up">
        5th semester Information Systems & Technology student at Cyber University with strong leadership, analytical, and creative skills. Currently serving as President of the Student Council (BEM). I thrive in collaborative environments, combining my passion for data, technology, and leadership.
      </p>
